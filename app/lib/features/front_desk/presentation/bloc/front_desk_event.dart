...
class LoadQueueHistoryEvent extends FrontDeskEvent {
  final int page;
  const LoadQueueHistoryEvent({this.page = 0});

  @override
  List<Object?> get props => [page];
}

class FetchPractitionersAndPolyclinicsEvent extends FrontDeskEvent {
  const FetchPractitionersAndPolyclinicsEvent();
}

class FetchIssuersEvent extends FrontDeskEvent {
  const FetchIssuersEvent();
}
