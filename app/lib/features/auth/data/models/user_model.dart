...
class UserModel extends UserEntity {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    ...
    return UserModel(
      id: json['id'] ?? json['email']?.hashCode ?? 0,
      ...
      birthday: patient != null && patient['birthday'] != null
          ? DateTime.parse(patient['birthday'])
          : null,
      phone: patient != null
      ...
      locationNote: patient != null
          ? patient['locationNote']?.toString()
          : null,
