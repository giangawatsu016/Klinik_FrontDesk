...
| :--- | :--- | :--- | :--- | :--- |
| **TC-01** | User can successfully [Action] | 1. Go to [Page] 2. Click [Button] 3. Enter [Data] | System redirects to [Page] and shows success toast. | ⏳ Pending |
| **TC-02** | System handles empty input | 1. Leave [Field] empty 2. Submit | specific error message "X is required" appears. | ⏳ Pending |
