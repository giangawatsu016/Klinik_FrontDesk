...
- [x] Create User Story V1.0 (Bahasa Indonesia)
- [x] Create User Flow V1.0 (Bahasa Indonesia)
- [x] Cleanup Unused Files (Screens & Temp Dirs)
- [x] Update Application to GitLab (Frontend & Backend)
- [x] Update Application to GitHub (Main Repo)
